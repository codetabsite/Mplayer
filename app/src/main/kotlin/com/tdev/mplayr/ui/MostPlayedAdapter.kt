...
class MostPlayedAdapter : RecyclerView.Adapter<MostPlayedAdapter.VH>() {
    ...
    inner class VH(v: View) : RecyclerView.ViewHolder(v) {
        val title:  TextView = v.findViewById(R.id.tvStatTitle)
        val artist: TextView = v.findViewById(R.id.tvStatArtist)
        val count:  TextView = v.findViewById(R.id.tvStatCount)
    }
